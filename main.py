...
class Data_Spider():
    ...
    def spider_some_note(self, notes: list, cookies_str: str, base_path: dict, save_choice: str, excel_name: str = '', transcode=False, proxies=None):
        """
        爬取一些笔记的信息
        :param notes:
        :param cookies_str:
    ...
    def spider_user_all_note(self, user_url: str, cookies_str: str, base_path: dict, save_choice: str, excel_name: str = '', transcode=False, proxies=None):
        """
        爬取一个用户的所有笔记
        :param user_url:
        :param cookies_str:
        ...
        try:
            ...
            self.spider_some_note(note_list, cookies_str, base_path, save_choice, excel_name, transcode, proxies)
        except Exception as e:
            success = False
            msg = e
    ...
    def spider_some_search_note(self, query: str, require_num: int, cookies_str: str, base_path: dict, save_choice: str, sort_type_choice=0, note_type=0, note_time=0, note_range=0, pos_distance=0, geo: dict = None,  excel_name: str = '', transcode=False, proxies=None):
        """
